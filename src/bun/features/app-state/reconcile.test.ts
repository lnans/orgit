...
describe('reconcileAppState', () => {
  ...
  test('clears selected repository when it no longer exists', () => {
    const state = baseState({
      ...
      repositories: [{ name: 'kept', path: '/ws/kept', branch: 'main', worktrees: [] }],
    })
      ...
      repositories: [
        {
          ...
          path: '/ws/kept',
          branch: 'main',
          worktrees: [{ name: 'wt-a', path: '/ws/kept/wt-a', filesModified: 0, linesAdded: 0, linesRemoved: 0 }],
        },
      ],
    })
      ...
      repositories: [
        {
          ...
          path: '/ws/repo',
          branch: 'main',
          worktrees: [{ name: 'new', path: '/ws/repo/new-wt', filesModified: 0, linesAdded: 0, linesRemoved: 0 }],
        },
      ],
    })
      ...
      repositories: [
        {
          ...
          path: '/ws/repo',
          branch: 'main',
          worktrees: [{ name: 'wt-a', path: '/ws/repo/wt-a', filesModified: 0, linesAdded: 0, linesRemoved: 0 }],
        },
      ],
    })
