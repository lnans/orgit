...
export type GitResult = { ok: true; stdout: string } | { ok: false; status: number; stdout: string; args: string[] }
...
export async function runGitAsync(cwd: string, args: string[]): Promise<GitResult> {
  try {
