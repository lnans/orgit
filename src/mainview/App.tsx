      ...
      <div className="container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="bg-white rounded-xl shadow-xl p-8 mb-8">
          ...
          <p className="mb-4 text-gray-600">
            Click the button below to test React state. With HMR enabled, you can edit this component and see changes instantly
        ...
        <div className="bg-white rounded-xl shadow-xl p-8 mb-8">
          <h2 className="text-2xl font-semibold text-indigo-600 mb-4">Getting Started</h2>
          <ul className="space-y-3 text-gray-700">
            <li className="flex items-start gap-2">
              <span className="text-indigo-500 font-bold">1.</span>
              <span>
                Run <code className="bg-gray-100 px-2 py-1 rounded text-sm">bun run dev</code> for development without HMR
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-indigo-500 font-bold">2.</span>
              <span>
                Run <code className="bg-gray-100 px-2 py-1 rounded text-sm">bun run dev:hmr</code> for development with hot reload
              </span>
            </li>
            <li className="flex items-start gap-2">
        ...
        <div className="text-center text-white/80 mt-10 p-6 bg-white/10 rounded-lg backdrop-blur">
          <p>
            Edit <code className="bg-white/20 px-2 py-1 rounded text-sm">src/mainview/App.tsx</code> and save to see HMR in action
          </p>
        </div>
      </div>
    </div>
